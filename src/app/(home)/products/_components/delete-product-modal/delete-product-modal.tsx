...
const DeleteProductComp = ({ isOpen, setIsOpen }: ModalProps) => {
  const handleCancel = () => {
    setIsOpen(false);
  };
          ...
          <div className='flex flex-col items-center text-center space-y-4'>
            ...
            <div className='flex flex-row gap-3 w-full pt-4 '>
              <Button
                ...
                className='flex-1 bg-gray-200 text-gray-800 py-3 px-[105px] rounded-md hover:bg-gray-300'
              >
                No
              </Button>
              <Button
                type='button'
                className='flex-1 bg-red-500 text-white py-3 px-[90px] rounded-md hover:bg-red-600'
              >
                Remove
              </Button>
            </div>
